...
# Generated on: Sat Mar 15 17:30:11 IST 2025 (Sat Mar 15 12:00:11 UTC 2025)
...
set logfile fv/Pipelined_Multiplier/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/Pipelined_Multiplier -revised fv_map
...
set env(CDN_SYNTH_ROOT) "/home/ece_student/install/install/GENUS211/tools.lnx86"
set CDN_SYNTH_ROOT      "/home/ece_student/install/install/GENUS211/tools.lnx86"
set env(CW_DIR) "/home/ece_student/install/install/GENUS211/tools.lnx86/lib/chipware"
set CW_DIR      "/home/ece_student/install/install/GENUS211/tools.lnx86/lib/chipware"
set lec_version_required "21.20249"
if { ($lec_version < $lec_version_required) &&
    [file exists /home/ece_student/install/install/GENUS211/tools.lnx86/lib/chipware/old_encrypt_sim]} {
    set env(CW_DIR_SIM) "/home/ece_student/install/install/GENUS211/tools.lnx86/lib/chipware/old_encrypt_sim"
    set CW_DIR_SIM      "/home/ece_student/install/install/GENUS211/tools.lnx86/lib/chipware/old_encrypt_sim"
} else {
    set env(CW_DIR_SIM) "/home/ece_student/install/install/GENUS211/tools.lnx86/lib/chipware/sim"
    set CW_DIR_SIM      "/home/ece_student/install/install/GENUS211/tools.lnx86/lib/chipware/sim"
}
...
add_search_path /home/ece_student/ec499_maaz/Pipelined_Multiplier/genus/library -library -both
read_library -liberty -both \
    /home/ece_student/ec499_maaz/Pipelined_Multiplier/genus/library/fast.lib \
    /home/ece_student/ec499_maaz/Pipelined_Multiplier/genus/library/fast.lib
...
add_search_path /home/ece_student/ec499_maaz/Pipelined_Multiplier/genus/verilog -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  /home/ece_student/ec499_maaz/Pipelined_Multiplier/genus/verilog/Pipelined_Multiplier.v
elaborate_design -golden -root {Pipelined_Multiplier} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/Pipelined_Multiplier/fv_map.v.gz
elaborate_design -revised -root {Pipelined_Multiplier}
...
#add_name_alias fv/Pipelined_Multiplier/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.Pipelined_Multiplier.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.Pipelined_Multiplier.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.Pipelined_Multiplier.rtl.fv_map.rpt
